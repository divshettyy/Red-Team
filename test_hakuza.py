...
class TestTechniqueLibrary:
    ...
    def test_technique_count_reasonable(self):
        """Verify technique count is reasonable (> 10, < 200) for Phase 4 expansion."""
        techniques = mod_techniques.load_techniques()
        assert 10 < len(techniques) < 200, \
            f"Technique count {len(techniques)} seems unreasonable (expected 10-200)"
